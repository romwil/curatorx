...
In-repo documentation for operators deploying CuratorX 1.0 on Docker or Unraid.
...
| [Library Sync](Library-Sync.md) | Indexing Plex, progress, durable jobs |
| [Multi-User](Multi-User.md) | Optional household auth (Plex login) |
