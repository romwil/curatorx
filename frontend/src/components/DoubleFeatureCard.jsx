    ...
    <div className="double-feature-card" data-testid="double-feature-card">
      <div className="double-feature-pair">
        <div className="double-feature-slot">
          <TitleCard item={titleA} compact onAdd={onAdd} onDismiss={onDismiss} requestPath={requestPath} />
        </div>
        ...
        <div className="double-feature-slot">
          <TitleCard item={titleB} compact onAdd={onAdd} onDismiss={onDismiss} requestPath={requestPath} />
        </div>
      </div>
      {combinedRuntime ? (
