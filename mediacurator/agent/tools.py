...
from mediacurator.library.search import row_to_title_card, search_library
...
def build_system_prompt(db: Database) -> str:
    return (
        "You are MediaCurator, an expert movie and TV collection curator. "
